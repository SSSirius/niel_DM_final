...
(function() {
  ...
  this.startRawScoreStreaming = function() {
    ...
    this.source = new EventSource("http://emojitrack-gostreamer.herokuapp.com/subscribe/raw");
  ...
  this.startCappedScoreStreaming = function() {
    ...
    this.source = new EventSource("http://emojitrack-gostreamer.herokuapp.com/subscribe/eps");
    return this.source.onmessage = function(event) {
  ...
  this.startDetailStreaming = function(id) {
    console.log("Subscribing to detail stream for 1F602" );
    this.detail_id = "1F602";
    this.detail_source = new EventSource("http://emojitrack-gostreamer.herokuapp.com/subscribe/details/1F602");
    return this.detail_source.addEventListener("stream.tweet_updates.1F602" , processDetailTweetUpdate, false);
  };
  ...
  this.forceCloseDetailStream = function(id, async) {
    ...
    $.ajax({
      type: 'POST',
      url: "http://emojitrack-gostreamer.herokuapp.com/subscribe/details/1F602",
  ...
  get_cached_selectors = function(id) {
    ...
    if (this.selector_cache[id] !== void 0) {
      ...
      score_selector = document.getElementById("score-1F602");
